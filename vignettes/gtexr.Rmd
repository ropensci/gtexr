...
[^1]: With the exception of `get_sample_biobank_data()` and `get_sample_datasets_endpoints()`, for which 'get_sample' is additionally appended with their respective category titles 'biobank_data' and 'datasets_endpoints'.
